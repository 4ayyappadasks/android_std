...
import 'fixed_static_input.dart';
...
void main()
{
  ...
  print("\t\t ENTER DETAILS OF STUDENTS (name , roll_no ,cgpa), MARK OBTAINED FOR MATHS AND PHYSICS , CLASS AND DIVSION");
  ...
  print("class and div : ${Student_Details.Classs} \t ${Student_Details.Div}");
  ...
  print("${st1.name}score>${st2.name}score = ${st1.maths_mark > st2.maths_mark}");
  print("\nFIND THE TOPPER IN PHYSICS");
  print("${st1.name}score>${st2.name}score = ${st1.physics_mark > st2.physics_mark}");
}